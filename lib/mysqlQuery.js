...
async function addRole() {
    ...
    //gets the chosen departments Id
    let departmentId;
...
const answers = await prompt([
    ...
    //gets the Id of the chosen items
    let employeeId;
    ...
    //updates the chosen employee to the chosen role
